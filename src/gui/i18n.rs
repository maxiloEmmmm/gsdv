...
fn chinese_text(source: &'static str) -> &'static str {
    match source {
        ...
        "Focus workspace" => "聚焦工作区",
        "Unfocus workspace" => "取消聚焦工作区",
        "Show focused workspaces only" => "仅显示聚焦工作区",
        "Change workspace directory" => "切换工作区目录",
        "Outline" => "大纲",
        "Work-flow" => "工作流",
        "No favorites" => "暂无收藏",
        ...
        "Confirm Delete" => "确认删除",
        "Close Workspace" => "关闭工作区",
        "Change Workspace Directory Failed" => "切换工作区目录失败",
        "Restart agents" => "重启 Agent",
        "Restarted {count} agent(s)" => "已重启 {count} 个 Agent",
        ...
        "Toggle recent Helix targets" => "切换最近 Helix 目标",
        "Workspace and terminal drawer" => "工作区和终端抽屉",
        "Toggle outline and Work-flow" => "切换大纲和 Work-flow",
        "Toggle extra tools" => "切换额外工具",
        "Agent center" => "Agent 中间区域",
        ...
        "Open recent Markdown outline" => "打开最近 Markdown 大纲",
        "Center tabs" => "中间标签",
        ...
        "Send current Helix file line to Agent" => "发送当前 Helix 文件行到 Agent",
        "Helix drawer" => "Helix 抽屉",
        "Open terminal file line in Helix" => "在 Helix 中打开终端文件行",
        "Agent terminal output" => "Agent 终端输出",
        ...
        "Open selected reviewer target in Helix" => "在 Helix 中打开选中的 reviewer 目标",
...
fn japanese_text(source: &'static str) -> &'static str {
    match source {
        ...
        "Change workspace directory" => "ワークスペースのディレクトリを変更",
        "Outline" => "アウトライン",
        "Work-flow" => "ワークフロー",
        ...
        "Close Workspace" => "ワークスペースを閉じる",
        "Focus workspace" => "ワークスペースをフォーカス",
        "Unfocus workspace" => "ワークスペースのフォーカスを解除",
        "Show focused workspaces only" => "フォーカスしたワークスペースのみ表示",
        "Change Workspace Directory Failed" => "ワークスペースのディレクトリ変更に失敗しました",
        "Restart agents" => "Agent を再起動",
        "Restarted {count} agent(s)" => "{count} 個の Agent を再起動しました",
        ...
        "Toggle recent Helix targets" => "最近の Helix ターゲットを切り替え",
        "Workspace and terminal drawer" => "ワークスペースとターミナルドロワー",
        "Toggle outline and Work-flow" => "アウトラインと Work-flow を切り替え",
        "Toggle extra tools" => "追加ツールを切り替え",
        "Agent center" => "Agent 中央",
        ...
        "Open recent Markdown outline" => "最近の Markdown アウトラインを開く",
        "Center tabs" => "中央タブ",
        ...
        "Send current Helix file line to Agent" => "現在の Helix ファイル行を Agent に送る",
        "Helix drawer" => "Helix ドロワー",
        "Open terminal file line in Helix" => "ターミナルのファイル行を Helix で開く",
        "Agent terminal output" => "Agent ターミナル出力",
        ...
        "Open selected reviewer target in Helix" => "選択した reviewer ターゲットを Helix で開く",
